...
const experiences = [
  ...
  {
    title: "Data Editor",
    company: "National Bureau of Statistics, Nigeria.",
    period: "Aug 2022 - October 2022",
    description: `Worked as a Data Editor at the National Bureau of Statistics, Nigeria, on the National Agricultural Sample Census (NASC) project where I was responsible for validating data collected from various sources.
