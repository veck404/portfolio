...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        heading: ['"Space Grotesk"', "system-ui", "sans-serif"], // Bold, distinctive headings
        body: ['"Sora"', "system-ui", "sans-serif"], // Modern, stylish body text
        sans: ['"Sora"', "system-ui", "sans-serif"],
        accent: ['"Outfit"', "system-ui", "sans-serif"], // Geometric, trendy accents
